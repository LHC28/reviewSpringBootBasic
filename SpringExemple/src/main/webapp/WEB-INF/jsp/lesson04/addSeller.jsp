...
<body>
	<div class="container">
		...
		<form method="post" action="/lesson04/quiz01/add_seller">
			...
			<span class="">프로필 사진 url</span><br>
			<input type="text" name="profileImageUrl" class="form-control col-9"><br>
		
			<span>온도</span><br>
			<input type="text" name="temparature" class="form-control col-3"><br>
